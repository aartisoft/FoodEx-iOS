...
class PurchasesVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    fileprivate func createItems() -> [Promo] {
        let promos = [
            Promo(image: UIImage(named: "promo_0"), title: "+100 UAH for each dropped kilogram", date: "13 Oct"),
            Promo(image: UIImage(named: "promo_1"), title: "VIP card", date: "13 Oct"),
            Promo(image: UIImage(named: "promo_2"), title: "2 programs to one address - discount", date: "13 Oct"),
            Promo(image: UIImage(named: "promo_3"), title: "+150 UAH for each friend's order", date: "13 Oct"),
            Promo(image: UIImage(named: "promo_4"), title: "Order 3 salads + 1 is a gift", date: "13 Oct"),
            Promo(image: UIImage(named: "promo_5"), title: "Become a FoodEx partner", date: "13 Oct")
        ]
        return promos
    }
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: PromoCard.identifier, for: indexPath) as! PromoCard
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let promo = promos[(indexPath as NSIndexPath).row]
        let alert = UIAlertController(title: promo.title, message: nil, preferredStyle: .alert)
